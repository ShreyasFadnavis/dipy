# -*- coding: utf-8 -*-
"""
Created on Tue Nov 14 15:11:41 2017
...
nib.save(nib.Nifti1Image(activeax_fit[:, :, :, 0], affine), 'f11_in_vivo_activeax_crossing.nii.gz')
nib.save(nib.Nifti1Image(activeax_fit[:, :, :, 1], affine), 'f12_in_vivo_activeax_crossing.nii.gz')
nib.save(nib.Nifti1Image(activeax_fit[:, :, :, 2], affine), 'f3_in_vivo_activeax_crossing.nii.gz')
nib.save(nib.Nifti1Image(activeax_fit[:, :, :, 3], affine), 'theta1_in_vivo_activeax_crossing.nii.gz')
nib.save(nib.Nifti1Image(activeax_fit[:, :, :, 4], affine), 'phi1_in_vivo_activeax_crossing.nii.gz')
nib.save(nib.Nifti1Image(activeax_fit[:, :, :, 5], affine), 'R1_in_vivo_activeax_crossing.nii.gz')
nib.save(nib.Nifti1Image(activeax_fit[:, :, :, 6], affine), 'f21_in_vivo_activeax_crossing.nii.gz')
nib.save(nib.Nifti1Image(activeax_fit[:, :, :, 7], affine), 'f22_in_vivo_activeax_crossing.nii.gz')
nib.save(nib.Nifti1Image(activeax_fit[:, :, :, 8], affine), 'f4_in_vivo_activeax_crossing.nii.gz')
nib.save(nib.Nifti1Image(activeax_fit[:, :, :, 9], affine), 'theta2_in_vivo_activeax_crossing.nii.gz')
nib.save(nib.Nifti1Image(activeax_fit[:, :, :, 10], affine), 'phi2_in_vivo_activeax_crossing.nii.gz')
nib.save(nib.Nifti1Image(activeax_fit[:, :, :, 11], affine), 'R2_in_vivo_activeax_crossing.nii.gz')
#t2 = time()
#fast_time = t2 - t1
#print(fast_time)
