...
class IvimModel(ReconstModel):
    ...
    def __init__(self, gtab, split_b_D=400.0, split_b_S0=200., bounds=None,
        ...
        if gtab.b0_threshold > 0:
            b0_s = "The IVIM model requires a measurement at b==0."
            b0_s += "As of version 0.15, the default b0_threshold for the "
            ...
            b0_s += "b0_threshold larger than 0. " 
            b0_s += "Please initialize the gtab input with b0_threshold=0."
